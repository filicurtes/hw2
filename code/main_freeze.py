...
##CHECK WHAT NET WILL TRAIN
for name,parameter in net.named_parameters():
  if parameter.requires_grad == True:
    print("\t",name)

#parameters_to_optimize = params_to_update # In this case we optimize over all the parameters of AlexNet
...
if(FREEZE_FC==True):
  plot(loss_train_list,loss_val_list,'loss','loss_train','loss_val','Loss vs Epochs',f'freeze_FC_loss_train_pre',set)

  plot(acc_train_list,acc_val_list,'accuracy','accuracy_train','accuracy_val','Accuracy vs Epochs',f'freeze_FC_acc_train_pre',set)
  ...
  results_df.to_csv(f'{set}_FC_freeze_results.csv',index=False)
else:
  plot(loss_train_list,loss_val_list,'loss','loss_train','loss_val','Loss vs Epochs',f'freeze_CONV_loss_train_pre',set)

  plot(acc_train_list,acc_val_list,'accuracy','accuracy_train','accuracy_val','Accuracy vs Epochs',f'freeze_CONV_acc_train_pre',set)
  ...
  results={'acc_train':acc_train_list,'loss_train':loss_train_arr,'acc_val':acc_val_arr,'loss_val':loss_val_list}
  results_df=pd.DataFrame(results)
  results_df.to_csv(f'{set}_CONV_freeze_results.csv',index=False)
