...
train_transform = transforms.Compose([transforms.Resize(256),      # Resizes short size of the PIL image to 256
                                      ...
                                      transforms.RandomVerticalFlip(p=0.5),    # 224 because torchvision's AlexNet needs a 224x224 input!
...
plot(loss_train_list,loss_val_list,'loss','loss_train','loss_val','Loss vs Epochs',f'augm{augm_set}_loss_train_pre',set)

plot(acc_train_list,acc_val_list,'accuracy','accuracy_train','accuracy_val','Accuracy vs Epochs',f'augm{augm_set}acc_train_pre',set)
...
results_df.to_csv(f'{set}_augm{augm_set}_results.csv',index=False)
os.chdir(owd)