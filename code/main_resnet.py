...
net = models.resnet18(pretrained=True) # Loading AlexNet model
...
plot(loss_train_list,loss_val_list,'loss','loss_train','loss_val','Loss vs Epochs',f'resnet_loss_train_pre',set)

plot(acc_train_list,acc_val_list,'accuracy','accuracy_train','accuracy_val','Accuracy vs Epochs',f'resnet_acc_train_pre',set)
...
results_df.to_csv(f'resnet_{set}_results.csv',index=False)
os.chdir(owd)